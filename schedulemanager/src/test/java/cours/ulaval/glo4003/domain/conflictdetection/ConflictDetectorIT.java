...
public class ConflictDetectorIT extends ITTestBase {
	...
	public void setUp() throws Exception {
		...
		glo2002Section = new Section("87134", "A", "a responsable person", Arrays.asList("teacher1"), TeachMode.InCourse, new TimeDedicated(3, 0, 6),
				"GLO-2002", Arrays.asList(new TimeSlot(generateTimeSlotStartTime(), 3, DayOfWeek.MONDAY)), null);
	...
	@Test
	public void canDetectConflicts() throws Exception {
	...
	@Test
	public void canDetectConflictsForSchedule() throws Exception {
	...
	@Test
	public void canTellThatSectionWillNotGenerateConflict() throws Exception {
	...
	@Test
	public void canTellThatSectionWillGenerateConflict() throws Exception {
