...
<body>
	...
	<sec:authorize access="hasAnyRole('ROLE_Responsable')">
		...
		<p>
			Les plages horaires indiquées en <span class="yellow">jaune</span> sont des sections de laboratoire.
		</p>
		<p>
			Les plages horaires indiquées en <span class="red">rouge</span> sont en conflits, soit avec une autre plage horaire ou avec une disponibilité d'un professeur.
		</p>
		<p>
			Posez votre curseur sur l'icône <i class="icon-fire"></i> afin d'obtenir les détails sur le(s) conflit(s) conçernant un cours.
		</p>
	</sec:authorize>
	<div class="btn-group">
		<c:url var="url" value="/schedule/${id}/list"></c:url>
		<a href="${url}" type="button" class="btn">Liste</a> <a href="#" type="button" class="btn active">Calendrier</a>
	</div>
	...
	<div id="sendEmailDiv" style="display: none;">
		<div class="pull-right" style="padding-right: 50px;">
			<img class="loading" src="<c:url value="/resources/img/ajax-loader.gif" />" alt="" style="display: none;" /> <span id="emailSuccess" class="badge badge-success ajaxNotification"><i
				class="icon-ok icon-white"></i></span> <span id="emailFail" class="badge badge-important ajaxNotification"><i class="icon-remove icon-white"></i></span> <a id="sendEmailBtn"
				class="btn btn-large"> Envoyer un courriel* </a>
		</div>
		<br />
		<br />
		<br />
		<div class="pull-right" style="padding-right: 50px;">*Envoie un courriel aux usagers concernés par cet horaire pour les avertir qu'un nouvel horaire est disponible.</div>
	</div>
</body>
</html>
