...
<form action="${url}" method=POST scope="request" commandName="section">
  ...
  Heures de cours suggérées :<br />
	...
	<c:forEach var="timeSlot" items="${timeSlots}">
		<input class="radioCourse" type="radio" name="timeSlot" value="timeSlot${count}"
			onClick="proposeHour('${timeSlot.dayOfWeek}','${timeSlot.startTime}','${timeSlot.endTime}',${isLab})">&nbsp;&nbsp; ${timeSlot.dayOfWeek} : ${timeSlot.startTime} - ${timeSlot.endTime}<br />
