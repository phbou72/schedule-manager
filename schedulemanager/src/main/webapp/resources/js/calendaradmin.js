...
function redirectToEditSection() {
	...
	if (nrc) {
		var url = 'http://localhost:8080/schedulemanager/schedule/editsection/' + schedule.scheduleInfo.id + '/' + schedule.scheduleInfo.year + '/'
		        + schedule.scheduleInfo.semester + '/' + nrc + '/calendar';
