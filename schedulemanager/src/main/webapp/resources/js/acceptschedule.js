        ...
        function() {
	        ...
	        $(".btnSeeAccepted").click(
	                function(event) {
		                ...
		                $(this).popover(
		                        {
		                            title : "Choix des enseignants",
		                            content : "<b><span class=\"green\"> Enseignants qui ont accept&eacute; l'horaire : </span></b><br>" + approvedUsersHtml
		                                    + "<br><b><span class=\"redtext\"> Enseignants qui ont refus&eacute; l'horaire : </span></b><br>" + refusedUsersHtml
		                        }).popover('show');
	                });
        });